...
**Playability.** 12 of 22 platforms play out of the box. `apple-iigs`, `appleii`, `appleiii`, `aquarius`, `atari-st`, `atari8bit`, `mac`, `trs-80-color-computer`, `trs-80-mc-10`, `zx81` have no EmulatorJS core in RomM 4.9.2. ROMs filed there import, appear in the library and do nothing when played — which is a fine thing to want from a catalogue, and the reason the Hub warns rather than refuses.
