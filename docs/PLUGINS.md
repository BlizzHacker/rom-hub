...
| ❗ [Ludusavi (save locations)](https://github.com/BlizzHacker/rom-hub-ludusavi) | BlizzHacker ([repo](https://github.com/BlizzHacker/rom-hub-ludusavi)) | 0.1.0 | 2026-07-31 | [`v0.1.0` tarball](https://github.com/BlizzHacker/rom-hub-ludusavi/archive/refs/tags/v0.1.0.tar.gz) | `metadata` | ~~Gaseous~~ · Retrom · RomM | — | `raw.githubusercontent.com` |
...
| ✔ [Open BIOS](https://github.com/BlizzHacker/rom-hub-open-bios) | BlizzHacker ([repo](https://github.com/BlizzHacker/rom-hub-open-bios)) | 0.1.1 | 2026-08-01 | [`v0.1.1` tarball](https://github.com/BlizzHacker/rom-hub-open-bios/archive/refs/tags/v0.1.1.tar.gz) | `firmware` | Gaseous* · Retrom* · RomM | — | `raw.githubusercontent.com`, `github.com`, `release-assets.githubusercontent.com` |
...
| ✔ [Universal-DB (3DS/DS homebrew)](https://github.com/BlizzHacker/rom-hub-universal-db) | BlizzHacker ([repo](https://github.com/BlizzHacker/rom-hub-universal-db)) | 0.1.0 | 2026-07-29 | [`v0.1.0` tarball](https://github.com/BlizzHacker/rom-hub-universal-db/archive/refs/tags/v0.1.0.tar.gz) | `search`, `importer` | Gaseous* · Retrom* · RomM | — | `db.universal-team.net`, `github.com`, `*.githubusercontent.com`, `gitlab.com`, `codeberg.org`, `gbatemp.net`, `cdn.classicube.net`, `apotrisstorage.blob.core.windows.net` |
